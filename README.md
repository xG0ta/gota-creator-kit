...
| --- | --- | --- |
| **Windows** | [Instalador completo para Windows — GotaCreatorKit-3.2.41.exe](https://raw.githubusercontent.com/xG0ta/gota-creator-kit/main/GotaCreatorKit-3.2.41.exe) | Ejecuta este archivo. Instala el panel **y** el motor local de AutoFrame. |
| **Mac** | [Instalador completo para macOS — GotaCreatorKit-3.2.41-macOS.zip](https://raw.githubusercontent.com/xG0ta/gota-creator-kit/main/GotaCreatorKit-3.2.41-macOS.zip) | Descomprime el ZIP y abre **Instalar Gota Creator Kit.app**. Instala el panel **y** el motor local. |
...
2. Descarga y abre **GotaCreatorKit-3.2.41.exe**.
...
1. Cierra Premiere Pro.
2. Descarga y descomprime **GotaCreatorKit-3.2.41-macOS.zip**.
