...
| --- | --- | --- |
| **Windows** | [Instalador completo para Windows — GotaCreatorKit-3.2.72-Windows.exe](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.2.72/GotaCreatorKit-3.2.72-Windows.exe) | Ejecuta este archivo. Instala el panel **y** el motor local. |
| **Mac** | [Instalador completo para macOS — GotaCreatorKit-3.2.72-macOS.zip](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.2.72/GotaCreatorKit-3.2.72-macOS.zip) | Descomprime el ZIP y abre **Instalar Gota Creator Kit.command**. Instala el panel **y** el motor local. |
...
2. Descarga y abre **GotaCreatorKit-3.2.72-Windows.exe**.
...
1. Cierra Premiere Pro.
2. Descarga y descomprime **GotaCreatorKit-3.2.72-macOS.zip**.
