...
## Descarga correcta — versión 3.3.3

| Tu computadora | Descarga esto | Importante |
| --- | --- | --- |
| **Windows** | [Instalador completo para Windows — GotaCreatorKit-3.3.3-Windows.exe](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.3.3/GotaCreatorKit-3.3.3-Windows.exe) | Recomendado. Instala el panel y el motor local. También elimina copias UXP antiguas antes de instalar. |
| **Premiere 2026 sin Creative Cloud** | [ZIP completo: EXE + CCX — GotaCreatorKit-3.3.3-Premiere-2026-sin-Creative-Cloud.zip](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.3.3/GotaCreatorKit-3.3.3-Premiere-2026-sin-Creative-Cloud.zip) | Ejecuta primero el EXE y luego instala el CCX con un gestor compatible. Así también queda instalado el motor local. |
| **macOS** | [Instalador completo para macOS — GotaCreatorKit-3.3.3-macOS.zip](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.3.3/GotaCreatorKit-3.3.3-macOS.zip) | Descomprime el ZIP completo, instala el CCX dentro de `payload` y abre **Instalar Gota Creator Kit.app**. |
| **Premiere Pro 2021–2025.5** | [Gota Creator Kit Legacy 3.3.3 — ZXP firmado](https://github.com/xG0ta/gota-creator-kit/releases/download/v3.3.3/GotaCreatorKit-Legacy-Premiere-2021-a-2025.5-3.3.3.zxp) | Para Premiere 2024 y anteriores. Instálalo con ZXP Installer. |
...
2. Ejecuta `GotaCreatorKit-3.3.3-Windows.exe`.
