...
| **Mac** | [Instalador completo para macOS — GotaCreatorKit-3.2.46-macOS.zip](https://github.com/xG0ta/gota-creator-kit/raw/refs/heads/main/GotaCreatorKit-3.2.46-macOS.zip) | Descomprime el ZIP y abre **Instalar Gota Creator Kit.app**. Instala el panel **y** el motor local. |
...
2. Descarga y abre **GotaCreatorKit-3.2.46.exe**.
...
1. Cierra Premiere Pro.
2. Descarga y descomprime **GotaCreatorKit-3.2.46-macOS.zip**.
