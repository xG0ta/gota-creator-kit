...
| --- | --- | --- |
| **Windows** | [Instalador completo para Windows — GotaCreatorKit-3.2.44.exe](https://github.com/xG0ta/gota-creator-kit/raw/refs/heads/main/GotaCreatorKit-3.2.44.exe) | Ejecuta este archivo. Instala el panel **y** el motor local. |
| **Mac** | [Instalador completo para macOS — GotaCreatorKit-3.2.44-macOS.zip](https://github.com/xG0ta/gota-creator-kit/raw/refs/heads/main/GotaCreatorKit-3.2.44-macOS.zip) | Descomprime el ZIP y abre **Instalar Gota Creator Kit.app**. Instala el panel **y** el motor local. |
...
2. Descarga y abre **GotaCreatorKit-3.2.44.exe**.
...
1. Cierra Premiere Pro.
2. Descarga y descomprime **GotaCreatorKit-3.2.44-macOS.zip**.
